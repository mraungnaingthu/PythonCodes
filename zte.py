...
try:
    ...
    second_commands = [
        f'show gpon onu state gpon-olt_1/{s}/{p}\n',
        ' '
        '\n',
        ' '
        '\n',
    ...
    third_commands = [
        ...
        'exit\n\n',
        f'interface gpon-onu_1/{s}/{p}:{ont_id}\n',
        f'name {pppoe_id}\n',
        ...
        f'wan-ip 1 mode pppoe username {pppoe_id} password {pppoe_psw} vlan-profile HSI-{vlan} host 1\n',
